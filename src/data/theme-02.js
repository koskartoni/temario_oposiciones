// CÓDIGO CORREGIDO PARA SER FIEL AL ÍNDICE DEL PDF
...
export const theme02Data = {
  ...
  sections: [
    ...
    },
    {
      ...
      icon: "sitemap",
      content: [
        { type: 'keyConcept', title: 'Los 4 Pilares de Von Neumann', text: 'La arquitectura de Von Neumann describe un ordenador con 4 componentes principales interconectados por <strong>buses</strong>: <ul><li><strong>CPU (Unidad Central de Proceso):</strong> El cerebro que ejecuta las instrucciones.</li><li><strong>Memoria Principal:</strong> Almacena datos e instrucciones.</li><li><strong>Unidad de Entrada/Salida (E/S):</strong> Comunica con los periféricos.</li><li><strong>Buses:</strong> Los caminos que conectan todo.</li></ul>' }
      ]
    },
    {
    ...
    },
    {
        ...
        content: [
            ...
            { type: 'flowDiagram', title: 'Pirámide de la Jerarquía de Memoria',
                initialNodes: [
                    { id: 'reg', position: { x: 250, y: 0 }, data: { label: 'Registros CPU' }, style: { backgroundColor: '#d13838', color: 'white' } },
                    { id: 'cache', position: { x: 225, y: 80 }, data: { label: 'Caché (L1, L2, L3)' }, style: { backgroundColor: '#d18a38' } },
                    { id: 'ram', position: { x: 200, y: 160 }, data: { label: 'Memoria Principal (RAM)' }, style: { backgroundColor: '#d1c138' } },
                    { id: 'ssd', position: { x: 175, y: 240 }, data: { label: 'Almacenamiento Secundario (SSD)' }, style: { backgroundColor: '#38d18a' } },
                    { id: 'hdd', position: { x: 150, y: 320 }, data: { label: 'Almacenamiento Terciario (HDD, Cintas)' }, style: { backgroundColor: '#388ad1' } }
                ],
                initialEdges: []
            }
        ]
